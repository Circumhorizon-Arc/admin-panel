...
export function Sidebar({ isMobileMenuOpen = false, onCloseMobileMenu }: SidebarProps) {
    ...
    return (
        <>
            ...
            {/* Sidebar */}
            <div className={cn(
                "flex h-full w-64 flex-col bg-white border-r border-gray-200 fixed lg:static inset-y-0 left-0 z-50 transform transition-transform duration-300 ease-in-out",
